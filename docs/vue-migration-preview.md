...
check-in, reward/penalty ledger reversals, tombstones, dirty-state updates, and
  ...
  canvas interaction, public-library batch management, and independent remote
  preview/apply without unsafe uploads.
...
and protected remote flow; wheel protected upload/create and final management
polish; Fitness rest
