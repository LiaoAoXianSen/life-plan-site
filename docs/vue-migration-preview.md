...
local-only mirror rebuilding, and read-only independent remote preview; Fitness now covers full-field body metric
...
depth, independent apply/upload remote flows; and non-diary AI writeback modes. They are
